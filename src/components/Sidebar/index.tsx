          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <Link
                ...
                className="group relative flex items-center gap-2.5 rounded-xl px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-green-950 dark:hover:bg-meta-4"
              >
                <svg
                  className="fill-current"
                  width="18"
              ...
              {/* <!-- Menu Item Task --> */}
              <Link
                href="/tasks/task-kanban" // Adjust this to the actual route
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/infrastructure/livestock-management"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname ===
                                  "/infrastructure/livestock-management" &&
                                "text-white"
                              }`}
                            >
