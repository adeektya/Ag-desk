      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="border-b border-stroke px-4 pb-5 dark:border-strokedark md:px-6 xl:px-7.5">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden w-3/12 xl:block xl:w-3/12">
              <span className="font-medium">Description</span>
            </div>
            <div className="w-1/12 md:block xsm:w-62">
          ...
          <div className="flex flex-col gap-7">
            {leadsData.map((lead, key) => (
              <div className="flex items-center gap-3" key={key}>
                ...
                <div className="hidden w-1/12 xl:block xl:w-3/12">
                  <span className="font-medium">{lead.description}</span>
                </div>
                <div className="w-1/12 md:block lg:pl-10">
